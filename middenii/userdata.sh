...
for dir_path in /home/ec2-user/cloudtools/middenii/docker/*; do cd $dir_path && export dir_name=`echo $dir_path | sed -e "s/\/home\/ec2-user\/cloudtools\/middenii\/docker\///g"`; done
